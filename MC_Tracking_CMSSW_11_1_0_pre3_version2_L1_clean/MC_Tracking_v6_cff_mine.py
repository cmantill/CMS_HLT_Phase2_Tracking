...
hltPhase2L1StepTracks = cms.EDProducer( "TrackProducer",
    AlgorithmName = cms.string('L1Step'),
    ...
    alias = cms.untracked.string('hltPhase2L1StepTracks'),
    beamSpot = cms.InputTag("offlineBeamSpot"),
...
hltPhase2L1StepSelector = cms.EDProducer("MultiTrackSelector",
    beamspot = cms.InputTag("offlineBeamSpot"),
    src = cms.InputTag("hltPhase2L1StepTracks"),
...
hltPhase2L1StepTrackCutClassifier = cms.EDProducer( "TrackCutClassifier",
    src = cms.InputTag( "hltPhase2L1StepTracks" ),
    beamspot = cms.InputTag( "offlineBeamSpot" ),
...
hltPhase2InitialStepClusters = cms.EDProducer("TrackClusterRemoverPhase2",
    ...
    minNumberOfLayersWithMeasBeforeFiltering = cms.int32(0),
    oldClusterRemovalInfo = cms.InputTag(""),
    overrideTrkQuals = cms.InputTag("hltPhase2L1StepSelector","L1StepCut"),
    phase2OTClusters = cms.InputTag("siPhase2Clusters"),
    phase2pixelClusters = cms.InputTag("siPixelClusters"),
    trackClassifier = cms.InputTag("","QualityMasks"),
    trajectories = cms.InputTag("hltPhase2L1StepTracks")
)
...
hltPhase2L1TracksSequence = cms.Sequence(
    ...
    hltPhase2L1StepTrackCutClassifier
)
