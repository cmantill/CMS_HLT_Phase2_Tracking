...
hltPhase2GeneralTracks = cms.EDProducer("TrackListMerger",
    ...
    indivShareFrac = cms.vdouble(
        ...
        ##0.09
	1.0,1.0 , 1.0 # trackcutclassifier
    ),
    makeReKeyedSeeds = cms.untracked.bool(False),
    newQuality = cms.string('confirmed'),
    selectedTrackQuals = cms.VInputTag(
    cms.InputTag("L1StepSelector","L1StepCut"),
...
hltPhase2HighPtTripletStepClusters = cms.EDProducer("TrackClusterRemoverPhase2",
    ...
    #overrideTrkQuals = cms.InputTag("hltInitialStepSelector","initialStep"),
    overrideTrkQuals = cms.InputTag(""), # trackcutclassifier
    phase2OTClusters = cms.InputTag("siPhase2Clusters"),
    phase2pixelClusters = cms.InputTag("siPixelClusters"),
    trackClassifier = cms.InputTag("","QualityMasks"),
    trajectories = cms.InputTag("hltPhase2InitialStepTracks")#("hltPhase2InitialStepTracks")#("hltPhase2InitialStepTrackSelectionHighPurity")
)
...
hltHighPtTripletStepSelector = cms.EDProducer("MultiTrackSelector",
    beamspot = cms.InputTag("offlineBeamSpot"),
...
hltPhase2InitialStepClusters = cms.EDProducer("TrackClusterRemoverPhase2",
    ...
    minNumberOfLayersWithMeasBeforeFiltering = cms.int32(0),
    oldClusterRemovalInfo = cms.InputTag(""),
    overrideTrkQuals = cms.InputTag("L1StepSelector","L1StepCut"),
    #overrideTrkQuals = cms.InputTag(""), # trackcutclassifier
    phase2OTClusters = cms.InputTag("siPhase2Clusters"),
    phase2pixelClusters = cms.InputTag("siPixelClusters"),
    trackClassifier = cms.InputTag("","QualityMasks"),
    trajectories = cms.InputTag("L1CtfTracks")
)
...
hltInitialStepSelector = cms.EDProducer("MultiTrackSelector",
    beamspot = cms.InputTag("offlineBeamSpot"),
...
####L1 step
L1TrackStepTrajectoryFilter = cms.PSet(
    ComponentType = cms.string('CkfBaseTrajectoryFilter'),
...
L1TrackStepTrajectoryFilterInOut = cms.PSet(
    ComponentType = cms.string('CkfBaseTrajectoryFilter'),
    chargeSignificance = cms.double(-1.0),
    constantValueForLostHitsFractionFilter = cms.double(2.0),
    extraNumberOfHitsBeforeTheFirstLoop = cms.int32(4),
...
L1TrackStepTrajectoryBuilder =  cms.PSet(
    ComponentType = cms.string('GroupedCkfTrajectoryBuilder'),
    bestHitOnly = cms.bool(True),
    propagatorAlong = cms.string('PropagatorWithMaterial'),
    propagatorOpposite = cms.string('PropagatorWithMaterialOpposite'),
    trajectoryFilter = cms.PSet(refToPSet_ = cms.string('L1TrackStepTrajectoryFilter')),
    inOutTrajectoryFilter = cms.PSet(refToPSet_ = cms.string('L1TrackStepTrajectoryFilterInOut')),
...
L1TrackStepChi2Est = cms.ESProducer("Chi2ChargeMeasurementEstimatorESProducer",
...
L1CtfTracks = cms.EDProducer( "TrackProducer",
    AlgorithmName = cms.string('L1CtfStep'),
    Fitter = cms.string('FlexibleKFFittingSmoother'),
    GeometricInnerState = cms.bool(False),
    MeasurementTracker = cms.string(''),
    MeasurementTrackerEvent = cms.InputTag( "MeasurementTrackerEvent"),
...
L1StepPrimaryVerticesUnsorted = cms.EDProducer("PrimaryVertexProducer",
    TkClusParameters = cms.PSet(
        TkDAClusParameters = cms.PSet(
            Tmin = cms.double(2.0),
            Tpurge = cms.double(2.0),
    ...
    TrackLabel = cms.InputTag("L1CtfTracks"),
    beamSpotLabel = cms.InputTag("offlineBeamSpot"),
    verbose = cms.untracked.bool(False),
    vertexCollections = cms.VPSet(cms.PSet(
        algorithm = cms.string('AdaptiveVertexFitter'),
...
L1StepPrimaryVertices = cms.EDProducer("RecoChargedRefCandidatePrimaryVertexSorter",
    assignment = cms.PSet(
        maxDistanceToJetAxis = cms.double(0.07),
        maxDtSigForPrimaryAssignment = cms.double(4.0),
        maxDxyForJetAxisAssigment = cms.double(0.1),
    ...
    jets = cms.InputTag("ak4CaloJetsForTrkL1"),
    particles = cms.InputTag("L1StepTrackRefsForJets"),
    produceAssociationToOriginalVertices = cms.bool(False),
    produceNoPileUpCollection = cms.bool(False),
    producePileUpCollection = cms.bool(False),
    produceSortedVertices = cms.bool(True),
    ...
    trackTimeTag = cms.InputTag(""),
    usePVMET = cms.bool(True),
    vertices = cms.InputTag("L1StepPrimaryVerticesUnsorted")
)


ak4CaloJetsForTrkL1 = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
    ...
    radiusPU = cms.double(0.5),
    src = cms.InputTag("caloTowerForTrk"),
    srcPVs = cms.InputTag("L1StepPrimaryVerticesUnsorted"),
    useDeterministicSeed = cms.bool(True),
    voronoiRfact = cms.double(-0.9)
)

L1StepSelector = cms.EDProducer("MultiTrackSelector",
    beamspot = cms.InputTag("offlineBeamSpot"),
    src = cms.InputTag("L1CtfTracks"),
    trackSelectors = cms.VPSet(
        cms.PSet(
            applyAbsCutsIfNoPV = cms.bool(False),
            applyAdaptedPVCuts = cms.bool(True),
...
L1TrackCutClassifier = cms.EDProducer( "TrackCutClassifier",
    src = cms.InputTag( "L1CtfTracks" ),
    beamspot = cms.InputTag( "offlineBeamSpot" ),
    vertices = cms.InputTag( "hltPhase2PixelVertices" ), # pixelVertices previous hltPhase2FirstStepPrimaryVertices" ),
    qualityCuts = cms.vdouble( -0.7, 0.1, 0.7 ),
...
L1TrackSelectionHighPurity = cms.EDProducer( "TrackCollectionFilterCloner",
    minQuality = cms.string( "highPurity" ),
    copyExtras = cms.untracked.bool( True ),
    copyTrajectories = cms.untracked.bool( False ),
    originalSource = cms.InputTag( "L1CtfTracks" ),
    originalQualVals = cms.InputTag('L1TrackCutClassifier','QualityMasks' ),
    originalMVAVals = cms.InputTag('L1TrackCutClassifier','MVAValues' )
)
...
hltPhase2InitialStepSequence = cms.Sequence(
    ...
    hltInitialStepSelector
    #hltPhase2InitialStepTrackCutClassifier +
    #hltPhase2InitialStepTrackSelectionHighPurity
)

L1StepPVSequence = cms.Sequence(
    L1StepPrimaryVerticesUnsorted + #uses beamspot
    #L1StepTrackRefsForJets +
    caloTowerForTrk +
    ak4CaloJetsForTrkL1 +
    L1StepPrimaryVertices
)

L1TracksSequence = cms.Sequence(
